object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(123); 
  // VALUES are immutable constants. You can't change them once defined.
  val hello: String= "Hi!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
